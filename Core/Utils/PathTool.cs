...
public class PathTool
{
    ...
    public static string GetWebStreamPath()
    {
        string PathUrl = null;
        ...
        //return PathUrl;
            ...
            int startIndex = urlString.LastIndexOf("/", StringComparison.Ordinal);
            if (startIndex != -1)
            {
                StringBuilder url = new StringBuilder(Application.absoluteURL);
                url.Remove(startIndex, urlString.Length - startIndex);
                PathUrl = url.ToString()+"/StreamingAssets/";
            }
#endif
        return PathUrl;
